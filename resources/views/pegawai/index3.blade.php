...
<!-- <div class="modal-dialog modal-wide"> -->
<!-- <div class="modal-content" > -->
<!-- <form role="form" method="POST" enctype='multipart/form-data' action="{{route('datafoto.changeFileFoto')}}"> -->
<!-- <div class="modal-header"> -->
<!-- <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button> -->
<!-- </div> -->
<!-- <div class="modal-body"> -->
...
<input type="file" id="filefoto" class="form-control" name="filefoto"> -->
<!-- </div> -->
...
<!-- <td>
  ...
  class="btn btn-xs btn-warning" onclick="getEditForm({{$p->id}})"> Edit </a> 
</td> -->
...
@endcan
<!-- <a class='btn btn-xs btn-danger' onclick="if(confirm('Apakah anda yakin?')) deleteDataRemoveTR({{$p->id}})">Delete</a> -->
</td>
</tr>
