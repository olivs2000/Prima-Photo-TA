    ...
    <div class="row">
      <div class="col-md-6 col-md-offset-3">
        <div class="block text-center">
          <h2 class="text-center">Prima Photo</h2>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form class="text-left clearfix" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group">
                            <input id="numberphone" type="text" class="form-control @error('numberphone') is-invalid @enderror" name="numberphone" placeholder="Number Phone" value="{{ old('numberphone') }}" required autocomplete="numberphone" autofocus>
                        ...
                        <div class="form-group">
                            <label for="status" ><h5>Masuk Sebagai:</h5></label>  &nbsp &nbsp                       
