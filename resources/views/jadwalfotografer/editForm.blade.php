<form role="form" method="POST" action="{{url('jadwalfotografers/'.$data->id)}}">
    ...
    <div class="form-group">
      ...
      <select class="form-control" id="eDetailPemesanansId" name="detail_pemesanans_id">
          @foreach($data as $dp)
              <option value='{{$dp->id}}'>{{$dp->detail_pemesanans_id}}</option> 
          @endforeach
      </select>
   </div>
   ...
   <div class="form-group">
      ...
      <select class="form-control" id="eAdminStudiosId" name="admin_studios_id">
          @foreach($data as $df)
              <option value='{{$df->id}}'>{{$df->nama_admin}}</option> 
          @endforeach
      </select>
   </div>
