 ...
 <div class="row stats-overview-cont">
    ...
    <div class="col-md-2 col-sm-4">
      <div class="stats-overview stat-block">
        ...
        <div class="progress">
          <span style="width: 50%;" class="progress-bar progress-bar-info" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100">
          <span class="sr-only">
          11% Complete </span>
          </span>
        </div>
    ...
    <div class="col-md-2 col-sm-4">
      <div class="stats-overview stat-block">
        ...
        <div class="details">
          ...
          <div class="progress">
            <span style="width: 20%;" class="progress-bar progress-bar-warning" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100">
            <span class="sr-only">
            20% Complete </span>
            </span>
          </div>
    ...
    <div class="col-md-2 col-sm-4">
      <div class="stats-overview stat-block">
        ...
        <div class="details">
          ...
          <div class="progress">
            <span style="width: 5%;" class="progress-bar progress-bar-success" aria-valuenow="5" aria-valuemin="0" aria-valuemax="100">
            <span class="sr-only">
            5% Complete </span>
            </span>
          </div>
    ...
    <div class="col-md-2 col-sm-4">
        <div class="stats-overview stat-block">
          ...
          <div class="details">
            ...
            <div class="progress">
              <span style="width: 30%;" class="progress-bar progress-bar-success" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100">
              <span class="sr-only">
              30% Complete </span>
              </span>
            </div>
    ...
    <div class="col-md-2 col-sm-4">
        <div class="stats-overview stat-block">
          ...
          <div class="progress">
            <span style="width: 15%;" class="progress-bar progress-bar-info" aria-valuenow="15" aria-valuemin="0" aria-valuemax="100">
            <span class="sr-only">
            15% Complete </span>
            </span>
          </div>
      ...
      <div class="col-md-2 col-sm-4">
        <div class="stats-overview stat-block">
          ...
          <div class="details">
            ...
            <div class="progress">
              <span style="width: 11%;" class="progress-bar progress-bar-danger" aria-valuenow="11" aria-valuemin="0" aria-valuemax="100">
              <span class="sr-only">
              11% Complete </span>
              </span>
            </div>
      ...
      <div class="col-md-2 col-sm-4">
        <div class="stats-overview stat-block">
          ...
          <div class="progress">
            <span style="width: 25%;" class="progress-bar progress-bar-info" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">
            <span class="sr-only">
            25% Complete </span>
            </span>
          </div>
