			...
			<div class="row">
				...
				<div class="contact-form col-md-6 " >
					<form id="contact-form" method="post" action="" role="form">
						...
						<div class="form-group">
							<input type="text" placeholder="Alat fotografi yang dimiliki" class="form-control" name="subject" id="subject">
						</div>
						
						<div class="form-group">
							<textarea rows="6" placeholder="Pengalaman dalam bidang fotografi" class="form-control" name="message" id="message"></textarea>	
						</div>
